...
import com.pinyougou.sellersgoods.service.CitiesService;
...
public class CitiesController {
	...
	public PageInfo<TbCities> findPage(int page, int rows){
	...
	public PageInfo<TbCities> search(@RequestBody TbCities cities, int page, int rows  ){
