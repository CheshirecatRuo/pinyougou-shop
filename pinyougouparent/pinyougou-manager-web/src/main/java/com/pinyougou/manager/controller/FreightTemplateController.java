...
public class FreightTemplateController {
	...
	public PageInfo<TbFreightTemplate> findPage(int page, int rows){
	...
	public PageInfo<TbFreightTemplate> search(@RequestBody TbFreightTemplate freightTemplate, int page, int rows  ){
