...
public class SeckillGoodsController {
	...
	public PageInfo<TbSeckillGoods> findPage(int page, int rows){
	...
	public PageInfo<TbSeckillGoods> search(@RequestBody TbSeckillGoods seckillGoods, int page, int rows  ){
