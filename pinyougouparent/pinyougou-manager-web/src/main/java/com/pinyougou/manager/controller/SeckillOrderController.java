...
public class SeckillOrderController {
	...
	public PageInfo<TbSeckillOrder> findPage(int page, int rows){
	...
	public PageInfo<TbSeckillOrder> search(@RequestBody TbSeckillOrder seckillOrder, int page, int rows  ){
