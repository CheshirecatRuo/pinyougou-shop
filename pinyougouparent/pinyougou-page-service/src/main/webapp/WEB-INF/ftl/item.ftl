					...
					<div class="zoom">
						<#if (imageList?? && imageList?size>0)>
							...
							<div id="preview" class="spec-preview">
								<span class="jqzoom">
									<img style="width: 400px;height: 400px" jqimg="${imageList[0].url}" src="${imageList[0].url}" /></span>
							</div>
							<!--下方的缩略图-->
							...
							<#list specificationList as specList>
								<dl>
									...
									<#list specList.attributeValue as specValue>
										<dd><a href="javascript:;" class="{{isSelectedSpec('${specList.attributeName}', '${specValue}')}}" ng-click="selectSpec('${specList.attributeName}', '${specValue}')">${specValue}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
								</dl>
							</#list>
						</div>
						...
						<div class="summary-wrap">
							...
							<div class="fl">
								<ul class="btn-choose unstyled">
									<li>
										<a href="javascript:void(0)" ng-click="addCart()" target="" class="sui-btn  btn-danger addshopcar">加入购物车</a>
									</li>
								</ul>
							</div>
						</div>
