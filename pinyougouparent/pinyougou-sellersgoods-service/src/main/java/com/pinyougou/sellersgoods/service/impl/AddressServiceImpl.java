...
import com.pinyougou.sellersgoods.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
	 ...
	 */
	@Override
	public PageInfo<TbAddress> findPage(int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
		Page<TbAddress> addresses = (Page<TbAddress>) addressMapper.selectByExample(null);
		return new PageInfo<TbAddress>(addresses);
	}
	...
	public void delete(Long[] ids) {
		...
		@Override
	public PageInfo<TbAddress> findPage(TbAddress address, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
